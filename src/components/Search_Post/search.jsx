...
<div className="container_search">
     <h4 className="data_lenght"> Табылған өнім {this.state.result_length}</h4>
        <input
        ...
        <div className="null_data">  Берілген өнім табылмады<TextAnim text_main="тапайтын жереден табасын" width="20"/></div>
        ...
        <div  className="Container">
          ...
          {this.state.Result_filter.map((res) => {
            ...
            return (
              ...
              id={res.id} baseurl={url.baseUrl}
              image={url.baseUrl+res.image1} 
              title={ res.title } 
              content_text={res.context} 
              image1={res.image1}
              author={{"Author_user":res.user.username,"author_first_name":res.user.first_name,"author_last_name":res.user.last_name}} 
