   ...
   const Redux = () =>{
    ...
    return(
      ...
      :
        ...
        <Card >
        <CardContent>
        <h2 ><LocalFireDepartmentIcon color="primary"/>Сіздің өнімдеріңіз <LocalFireDepartmentIcon color="primary"/></h2> 
        <img style={{
...

         {
            ...
            :
                ...
                <Card variant="outlined"> 
                    ...
                    <h2 className="center" >Сіз өнімді салмадыңыз немесе администртор құқығыңыз жоқ</h2>
                    <Alert severity="info">
                    <AlertTitle>ARS-SHOP</AlertTitle>
                    Егер сіз администратор болсаңыз сіз қосымшаға өнімдер <strong>  тізімін сала аласыз </strong>
                    </Alert>
